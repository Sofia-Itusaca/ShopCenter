...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { color: @producto.color, description: @producto.description, price: @producto.price, stock: @producto.stock, titulo: @producto.titulo } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { color: @producto.color, description: @producto.description, price: @producto.price, stock: @producto.stock, titulo: @producto.titulo } }
